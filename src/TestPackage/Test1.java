...
public class Test1 {
    ...
    /*
        ...
        The working situation in the sample test 1 method is as follows:

        1) A user class human user is created and the necessary arguments are given.
        2) The item to be purchased and its color have been selected for the created user.
        3) A personalized inscription was given to be written on it.
        4) Values for the created user were logged to the console.

        5) A second user was created and steps 1 to 4 were repeated.

        6) 2. User's total fees were calculated and logged to the console.
        7) The total fees of 2 users were compared to ensure that the methods worked correctly.
